...
## 共通識別メモ（他翼との誤診防止）【必須・短文可】

後期正本と同じ解像度に揃えるための共通欄。観察のあとに埋めてもよいが、**メタの直後**に置くことを推奨。

### 姉妹翼切り分け

（同じベースタイプのもう一方の翼との差。表でも箇条でも可）
...
（誤診しやすい他タイプ／他翼。例: 6w5↔5w6、2↔9の合わせ）
...
（sp＝安全・資源／so＝地位・群れ／sx＝一対一・強度。未観測なら「未記入」）
...
（穏やか〜通常時の振る舞い。**応力ケースだけで平均像を代表させない**）
